# Migration `20191124190558-init`

This migration has been generated by Kristóf Poduszló at 11/24/2019, 7:05:58 PM.
...
You can use a specific Photon built for this migration (20191124190558-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191124190558-init';
