# Migration `20191127145417-init`

This migration has been generated by Kristóf Poduszló at 11/27/2019, 2:54:17 PM.
...
CREATE TABLE "lift"."QuizItem" (
  "id" TEXT NOT NULL   ,
  "quiz" TEXT NOT NULL   REFERENCES "Quiz"(id) ON DELETE RESTRICT,
...
You can use a specific Photon built for this migration (20191127145417-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191127145417-init';
