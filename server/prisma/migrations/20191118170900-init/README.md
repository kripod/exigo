# Migration `20191118170900-init`

This migration has been generated by Kristóf Poduszló at 11/18/2019, 5:09:00 PM.
...
You can use a specific Photon built for this migration (20191118170900-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191118170900-init';
