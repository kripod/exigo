# Migration `20191208012852-init`

This migration has been generated by Kristóf Poduszló at 12/8/2019, 1:28:52 AM.
...
You can use a specific Photon built for this migration (20191208012852-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191208012852-init';
