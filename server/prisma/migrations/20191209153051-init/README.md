# Migration `20191209153051-init`

This migration has been generated by Kristóf Poduszló at 12/9/2019, 3:30:51 PM.
...
You can use a specific Photon built for this migration (20191209153051-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191209153051-init';
