# Migration `20191122171222-init`

This migration has been generated by Kristóf Poduszló at 11/22/2019, 5:12:22 PM.
...
You can use a specific Photon built for this migration (20191122171222-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191122171222-init';
