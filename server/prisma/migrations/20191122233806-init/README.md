# Migration `20191122233806-init`

This migration has been generated by Kristóf Poduszló at 11/22/2019, 11:38:06 PM.
...
You can use a specific Photon built for this migration (20191122233806-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191122233806-init';
